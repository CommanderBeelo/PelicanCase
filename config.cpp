...
class CfgVehicles
{
	...
	class pelican_case: cs_openable_base 
	{
		scope = 2;
	...
	class pelican_jungle: cs_openable_base 
	{
		scope = 2;
	...
	class pelican_urban: cs_openable_base 
	{
		scope = 2;
	...
	class pelican_desert: cs_openable_base 
	{
		scope = 2;
	...
	class pelican_wilderness: cs_openable_base 
	{
		scope = 2;
